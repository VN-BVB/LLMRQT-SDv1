...
"""
spec_decoding.eagle3_sgl —— EAGLE3 多层特征 + EAGLE1 静态树 + 树掩码 verify（sglang 风格）。

= EAGLE1 的静态 top-k 树 + full_model_tree/reference_paths tree verify
+ EAGLE3 的target 低/中/高多层 hidden 拼接作为 draft 条件特征。
