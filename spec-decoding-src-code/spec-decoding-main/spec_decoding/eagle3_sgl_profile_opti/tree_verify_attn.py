...
def _triton_tree_attn_forward(
    ...
    **kwargs: Any,
    ...
    # transformers 5.x 把 attention 的 cache kwarg 从 past_key_value 改名为 past_key_values；
    ...
    # Qwen3 applies per-head Q/K RMSNorm before RoPE.  Llama attention has no
    # q_norm/k_norm attributes, so this is a no-op for the original target.
    # Omitting these norms changes verify logits and makes tree verification
    # lossy on Qwen3.
